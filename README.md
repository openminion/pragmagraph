...
<p align="center">
  <a href="https://pypi.org/project/pragmagraph/"><img alt="PyPI" src="https://img.shields.io/badge/pypi-v0.0.12rc1-3775A9"></a>
...
PragmaGraph `v0.0.12rc1` is a standalone public alpha package for facts that can be
