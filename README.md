...
<p align="center">
  <a href="https://pypi.org/project/pragmagraph/"><img alt="PyPI" src="https://img.shields.io/pypi/v/pragmagraph?cacheSeconds=300"></a>
...
PragmaGraph `v0.0.6` is a standalone semantic-alpha package for facts that can
...
| --- | --- |
| Package | `pragmagraph` |
| Current line | `v0.0.6` semantic alpha |
| Python | 3.11+ |
