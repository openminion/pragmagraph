...
<p align="center">
  <a href="https://pypi.org/project/pragmagraph/"><img alt="PyPI" src="https://img.shields.io/badge/pypi-v0.0.13rc1-3775A9"></a>
...
PragmaGraph `v0.0.13rc1` is a standalone public alpha package for facts that can be
...
| --- | --- |
| Package | `pragmagraph` |
| Current line | `v0.0.13rc1` public alpha |
| Python | 3.11+ |
