...
REQUEST_PAYLOAD_KEYS: Mapping[str, tuple[str, ...]] = {
    ...
    "pragmagraph_health": (),
    "pragmagraph_query": ("text", "node_ids", "max_results", "include_edges"),
    "pragmagraph_explain": ("text", "node_ids", "max_results", "include_edges"),
    "pragmagraph_neighborhood": ("node_id", "depth", "max_results"),
    "pragmagraph_path": ("source_id", "target_id", "max_hops"),
    "pragmagraph_report": ("top_n", "format"),
    "pragmagraph_export": ("format",),
